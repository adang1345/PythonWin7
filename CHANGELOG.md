...
- Rebuild all packages to support Windows Vista SP2 and Windows Server 2008 SP1.
- Add 3.8, which does not officially support Windows Vista SP2 and Windows Server 2008 SP1.
