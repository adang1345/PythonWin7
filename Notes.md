...
- Apply `add-dll-2.patch` for 3.11.0 or `add-dll-5.patch` for 3.11.1 or higher to ensure that `api-ms-win-core-path-l1-1-0.dll` is installed next to the Python executable.
