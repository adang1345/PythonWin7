...
- Apply `fix-vcruntime-threads-2.patch` to fix https://github.com/python/cpython/issues/115167.
- Run `buildrelease.bat`.

## Python 3.12

- For 3.12.0-3.12.1, install Sphinx 4.5.0 to a Python 3.11 venv and set `PYTHON` to the location of the Python executable. For 3.12.2 and higher, install Sphinx 7.2.6 to a Python 3.11 venv and set `PYTHON` to the location of the Python executable.
- Apply `add-dll.patch`.
